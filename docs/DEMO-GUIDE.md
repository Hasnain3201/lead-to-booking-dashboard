...
1. **Problem (hero):** “An owner receives inquiries, books appointments, and records finished jobs in different spreadsheets. They can't see where follow-up is missing.” Point at the gauge: 45.6% of 720 synthetic inquiries booked at least once.
...
4. **Sources:** Switch between *Volume*, *Booked*, and *Response*. Point out the sample sizes and the caveat: the demo data deliberately favors referrals, so this is a demonstration, not a market finding.
...
- [x] Launch the app from `serve.py` and load the synthetic demo. *(Sep 23, 2026)*
...
Afterward, note each misunderstanding and the change made because of it. This is real evidence; synthetic outcomes are not.
